...
public class MainProvider {
	...
	public static void main(String[] args) {
		...
		case 1:
			...
			System.out.println("Now the status of the client((true -  The registration is positive || false - The registration is negative):");
		...
		case 3:
			...
			provider = controller.getById(optionalId);
		...
		case 4:
			...
			case 3:
				...
				System.out.println("Type the new status (true -  The registration is positive || false - The registration is nagative");
				provider.setStatus(scan.nextBoolean());
				controller.update(provider);
			break;
